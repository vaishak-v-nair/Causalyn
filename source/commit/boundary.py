...
class CommitBoundary:
    ...
    def __init__(self, failure_dataset: Optional[FailurePatternDataset] = None,
        ...
        self.commit_history_path = commit_history_path or os.path.join(
            os.path.expanduser("~"), ".gstack", "commit_history.jsonl"
        )
    ...
    def prepare_commit(self,
                      ...
                      intent_text: Optional[str] = None) -> CommitRecord:
        """
        Prepare a commit attempt - runs verification and checks authorization.
