...
class RuntimeSettings:
    ...
    verification_provider: str = "nim"
    verification_model: str = "nvidia/llama-3.1-nemotron-70b-instruct"
    verification_timeout_s: int = 30

    def get_api_key(self, provider: str) -> str | None:
        p = provider.lower()
        if p in ("nim", "nvidia"):
            return self.nvidia_nim_key
        elif p == "groq":
    ...
    def from_env(cls) -> "RuntimeSettings":
        ...
        return cls(
            ...
            verification_provider=os.getenv("CAUSALYN_VERIFICATION_PROVIDER", "nim"),
            verification_model=os.getenv("CAUSALYN_VERIFICATION_MODEL", "nvidia/llama-3.1-nemotron-70b-instruct"),
            verification_timeout_s=int(os.getenv("CAUSALYN_VERIFICATION_TIMEOUT_S", "30")),
        )
...
CausalynConfig = RuntimeSettings
